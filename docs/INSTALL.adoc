...
== Performance Test
To run the built-in performance tests, you can use the following command:

[source, shell]
----
./mvnw test -P performance -Dparallel=4
----
The `-Dparallel=4 flag determines how many parallel runs to use in the performance test (the default is equal to amount of cores if you don't include this flag). The output will look something like this:

----
INFO PerformanceTest - ****    500.000 candlesticks  ****
INFO PerformanceTest -     feed filter              95 ms
INFO PerformanceTest -     base run                 95 ms
INFO PerformanceTest -     parallel runs (x4)      148 ms
INFO PerformanceTest -     extended run            412 ms
INFO PerformanceTest - ****  1.000.000 candlesticks  ****
INFO PerformanceTest -     feed filter             170 ms
INFO PerformanceTest -     base run                187 ms
INFO PerformanceTest -     parallel runs (x4)      293 ms
INFO PerformanceTest -     extended run           1397 ms
INFO PerformanceTest - ****  5.000.000 candlesticks  ****
INFO PerformanceTest -     feed filter             848 ms
INFO PerformanceTest -     base run                900 ms
INFO PerformanceTest -     parallel runs (x4)     1015 ms
INFO PerformanceTest -     extended run           9577 ms
INFO PerformanceTest - **** 10.000.000 candlesticks  ****
INFO PerformanceTest -     feed filter            1849 ms
INFO PerformanceTest -     base run               1815 ms
INFO PerformanceTest -     parallel runs (x4)     2060 ms
INFO PerformanceTest -     extended run          11706 ms
----
