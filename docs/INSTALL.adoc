...
The install it in the local Maven repository on your machine using the following command:
...
If this artefact is not found in your local Maven repository during build, the module `roboquant-ibkr` will be automatically skipped during the build phase. So if you don't need integration with Interactive Brokers for your use-case, you can skip this step.
