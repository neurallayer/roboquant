package org.roboquant.feeds.xchange
...
class XChangeFeed(
    ...
    private fun handleOrderBook(asset: Asset, orderBook: CryptoOrderBook) {
        ...
        val asks = orderBook.asks.map { OrderBook.OrderBookEntry(it.cumulativeAmount.toDouble(), it.limitPrice.toDouble()) }
        val bids = orderBook.bids.map { OrderBook.OrderBookEntry(it.cumulativeAmount.toDouble(), it.limitPrice.toDouble()) }
