...
object TALib {
    ...
    /**
     * Apply Vector Trigonometric ACos on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Math Transform.
     *
     */
    fun acos(data: DoubleArray, previous: Int = 0): Double {
        val endIdx = data.size - 1 - previous
        val outputSize = 1
    ...
    /**
     * Apply Chaikin A/D Line on the provided input and return the most recent output only.
     *
    ...
    fun ad(high: DoubleArray, low: DoubleArray, close: DoubleArray, volume: DoubleArray, previous: Int = 0): Double {
        val endIdx = high.size - 1 - previous
        val outputSize = 1
        val output1 = DoubleArray(outputSize)
        val startOutput = MInteger()
        val endOutput = MInteger()
    ...
    /**
     * Apply Vector Arithmetic Add on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Math Operators.
     *
     */
    fun add(data0: DoubleArray, data1: DoubleArray, previous: Int = 0): Double {
        val endIdx = data0.size - 1 - previous
        val outputSize = 1
        val output1 = DoubleArray(outputSize)
        val startOutput = MInteger()
        val endOutput = MInteger()
    ...
    /**
     * Apply Chaikin A/D Oscillator on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Volume Indicators.
     *
     */
    ...
    /**
     * Apply Average Directional Movement Index on the provided input and return the most recent output only.
     *
    ...
    /**
     * Apply Average Directional Movement Index Rating on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Momentum Indicators.
     *
     */
    ...
    /**
     * Apply Absolute Price Oscillator on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Momentum Indicators.
     *
     */
    ...
    /**
     * Apply Aroon on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Momentum Indicators.
     *
     */
    fun aroon(high: DoubleArray, low: DoubleArray, timePeriod: Int = 14, previous: Int = 0): Pair<Double, Double> {
        ...
        return Pair(output1[last], output2[last])
    }
    ...
    /**
     * Apply Aroon Oscillator on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Momentum Indicators.
     *
     */
    ...
    /**
     * Apply Vector Trigonometric ASin on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Math Transform.
     *
     */
    ...
    /**
     * Apply Vector Trigonometric ATan on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Math Transform.
     *
     */
    ...
    /**
     * Apply Average True Range on the provided input and return the most recent output only.
     *
    ...
    /**
     * Apply Average Price on the provided input and return the most recent output only.
     *
    ...
    fun avgPrice(
        ...
        val endIdx = open.size - 1 - previous
        val outputSize = 1
        val output1 = DoubleArray(outputSize)
        val startOutput = MInteger()
        val endOutput = MInteger()
    ...
    /**
     * Apply Bollinger Bands on the provided input and return the most recent output only.
     *
    ...
    fun bbands(
        ...
        return Triple(output1[last], output2[last], output3[last])
    }


    /**
     * Apply Beta on the provided input and return the most recent output only.
     *
    ...
    /**
     * Apply Balance Of Power on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Momentum Indicators.
     *
     */
    ...
    /**
     * Apply Commodity Channel Index on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Momentum Indicators.
     *
     */
    ...
    /**
     * Apply Two Crows on the provided input and return the most recent output only.
     *
    ...
    /**
     * Apply Three Black Crows on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Three Inside Up/Down on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Three-Line Strike on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Three Outside Up/Down on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Three Stars In The South on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Three Advancing White Soldiers on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Abandoned Baby on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Advance Block on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Belt-hold on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Breakaway on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Closing Marubozu on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Concealing Baby Swallow on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Counterattack on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Dark Cloud Cover on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Doji on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Doji Star on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Dragonfly Doji on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Engulfing Pattern on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Evening Doji Star on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Evening Star on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Up/Down-gap side-by-side white lines on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Gravestone Doji on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Hammer on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Hanging Man on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Harami Pattern on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Harami Cross Pattern on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply High-Wave Candle on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Hikkake Pattern on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Modified Hikkake Pattern on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Homing Pigeon on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Identical Three Crows on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply In-Neck Pattern on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Inverted Hammer on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Kicking on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Kicking - bull/bear determined by the longer marubozu on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Ladder Bottom on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Long Legged Doji on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Long Line Candle on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Marubozu on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Matching Low on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Mat Hold on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Morning Doji Star on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Morning Star on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply On-Neck Pattern on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Piercing Pattern on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Rickshaw Man on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Rising/Falling Three Methods on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Separating Lines on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Shooting Star on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Short Line Candle on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Spinning Top on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Stalled Pattern on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Stick Sandwich on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Takuri (Dragonfly Doji with very long lower shadow) on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Tasuki Gap on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Thrusting Pattern on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Tristar Pattern on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Unique 3 River on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Upside Gap Two Crows on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Upside/Downside Gap Three Methods on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Pattern Recognition.
     *
     */
    ...
    /**
     * Apply Vector Ceil on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Math Transform.
     *
     */
    ...
    /**
     * Apply Chande Momentum Oscillator on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Momentum Indicators.
     *
     */
    ...
    /**
     * Apply Pearson's Correlation Coefficient (r) on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Statistic Functions.
     *
     */
    ...
    /**
     * Apply Vector Trigonometric Cos on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Math Transform.
     *
     */
    ...
    /**
     * Apply Vector Trigonometric Cosh on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Math Transform.
     *
     */
    ...
    /**
     * Apply Double Exponential Moving Average on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Overlap Studies.
     *
     */
    ...
    /**
     * Apply Vector Arithmetic Div on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Math Operators.
     *
     */
    ...
    /**
     * Apply Directional Movement Index on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Momentum Indicators.
     *
     */
    ...
    /**
     * Apply Exponential Moving Average on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Overlap Studies.
     *
     */
    ...
    /**
     * Apply Vector Arithmetic Exp on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Math Transform.
     *
     */
    ...
    /**
     * Apply Vector Floor on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Math Transform.
     *
     */
    ...
    /**
     * Apply Hilbert Transform - Dominant Cycle Period on the provided input and return the most recent output only.
     *
    ...
    /**
     * Apply Hilbert Transform - Dominant Cycle Phase on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Cycle Indicators.
     *
     */
    ...
    /**
     * Apply Hilbert Transform - Phasor Components on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Cycle Indicators.
     *
     */
    ...
    /**
     * Apply Hilbert Transform - SineWave on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Cycle Indicators.
     *
     */
    ...
    /**
     * Apply Hilbert Transform - Instantaneous Trendline on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Overlap Studies.
     *
     */
    ...
    /**
     * Apply Hilbert Transform - Trend vs Cycle Mode on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Cycle Indicators.
     *
     */
    ...
    /**
     * Apply Kaufman Adaptive Moving Average on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Overlap Studies.
     *
     */
    ...
    /**
     * Apply Linear Regression on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Statistic Functions.
     *
     */
    ...
    /**
     * Apply Linear Regression Angle on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Statistic Functions.
     *
     */
    ...
    /**
     * Apply Linear Regression Intercept on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Statistic Functions.
     *
     */
    ...
    /**
     * Apply Linear Regression Slope on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Statistic Functions.
     *
     */
    ...
    /**
     * Apply Vector Log Natural on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Math Transform.
     *
     */
    ...
    /**
     * Apply Vector Log10 on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Math Transform.
     *
     */
    ...
    /**
     * Apply Moving average on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Overlap Studies.
     *
     */
    ...
    /**
     * Apply Moving Average Convergence/Divergence on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Momentum Indicators.
     *
     */
    ...
    /**
     * Apply MACD with controllable MA type on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Momentum Indicators.
     *
     */
    ...
    /**
     * Apply Moving Average Convergence/Divergence Fix 12/26 on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Momentum Indicators.
     *
     */
    ...
    /**
     * Apply MESA Adaptive Moving Average on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Overlap Studies.
     *
     */
    ...
    /**
     * Apply Moving average with variable period on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Overlap Studies.
     *
     */
    ...
    /**
     * Apply Highest value over a specified period on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Math Operators.
     *
     */
    ...
    /**
     * Apply Index of highest value over a specified period on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Math Operators.
     *
     */
    ...
    /**
     * Apply Median Price on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Price Transform.
     *
     */
    ...
    /**
     * Apply Money Flow Index on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Momentum Indicators.
     *
     */
    ...
    /**
     * Apply MidPoint over period on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Overlap Studies.
     *
     */
    ...
    /**
     * Apply Midpoint Price over period on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Overlap Studies.
     *
     */
    ...
    /**
     * Apply Lowest value over a specified period on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Math Operators.
     *
     */
    ...
    /**
     * Apply Index of lowest value over a specified period on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Math Operators.
     *
     */
    ...
    /**
     * Apply Lowest and highest values over a specified period on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Math Operators.
     *
     */
    ...
    /**
     * Apply Indexes of lowest and highest values over a specified period on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Math Operators.
     *
     */
    ...
    /**
     * Apply Minus Directional Indicator on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Momentum Indicators.
     *
     */
    ...
    /**
     * Apply Minus Directional Movement on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Momentum Indicators.
     *
     */
    ...
    /**
     * Apply Momentum on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Momentum Indicators.
     *
     */
    ...
    /**
     * Apply Vector Arithmetic Mult on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Math Operators.
     *
     */
    ...
    /**
     * Apply Normalized Average True Range on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Volatility Indicators.
     *
     */
    ...
    /**
     * Apply On Balance Volume on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Volume Indicators.
     *
     */
    ...
    /**
     * Apply Plus Directional Indicator on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Momentum Indicators.
     *
     */
    ...
    /**
     * Apply Plus Directional Movement on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Momentum Indicators.
     *
     */
    ...
    /**
     * Apply Percentage Price Oscillator on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Momentum Indicators.
     *
     */
    ...
    /**
     * Apply Rate of change : ((price/prevPrice)-1)*100 on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Momentum Indicators.
     *
     */
    ...
    /**
     * Apply Rate of change Percentage: (price-prevPrice)/prevPrice on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Momentum Indicators.
     *
     */
    ...
    /**
     * Apply Rate of change ratio: (price/prevPrice) on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Momentum Indicators.
     *
     */
    ...
    /**
     * Apply Rate of change ratio 100 scale: (price/prevPrice)*100 on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Momentum Indicators.
     *
     */
    ...
    /**
     * Apply Relative Strength Index on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Momentum Indicators.
     *
     */
    ...
    /**
     * Apply Parabolic SAR on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Overlap Studies.
     *
     */
    ...
    /**
     * Apply Parabolic SAR - Extended on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Overlap Studies.
     *
     */
    ...
    /**
     * Apply Vector Trigonometric Sin on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Math Transform.
     *
     */
    ...
    /**
     * Apply Vector Trigonometric Sinh on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Math Transform.
     *
     */
    ...
    /**
     * Apply Simple Moving Average on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Overlap Studies.
     *
     */
    ...
    /**
     * Apply Vector Square Root on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Math Transform.
     *
     */
    ...
    /**
     * Apply Standard Deviation on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Statistic Functions.
     *
     */
    ...
    /**
     * Apply Stochastic on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Momentum Indicators.
     *
     */
    ...
    /**
     * Apply Stochastic Fast on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Momentum Indicators.
     *
     */
    ...
    /**
     * Apply Stochastic Relative Strength Index on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Momentum Indicators.
     *
     */
    ...
    /**
     * Apply Vector Arithmetic Subtraction on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Math Operators.
     *
     */
    ...
    /**
     * Apply Summation on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Math Operators.
     *
     */
    ...
    /**
     * Apply Triple Exponential Moving Average (T3) on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Overlap Studies.
     *
     */
    ...
    /**
     * Apply Vector Trigonometric Tan on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Math Transform.
     *
     */
    ...
    /**
     * Apply Vector Trigonometric Tanh on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Math Transform.
     *
     */
    ...
    /**
     * Apply Triple Exponential Moving Average on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Overlap Studies.
     *
     */
    ...
    /**
     * Apply True Range on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Volatility Indicators.
     *
     */
    ...
    /**
     * Apply Triangular Moving Average on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Overlap Studies.
     *
     */
    ...
    /**
     * Apply 1-day Rate-Of-Change (ROC) of a Triple Smooth EMA on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Momentum Indicators.
     *
     */
    ...
    /**
     * Apply Time Series Forecast on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Statistic Functions.
     *
     */
    ...
    /**
     * Apply Typical Price on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Price Transform.
     *
     */
    ...
    /**
     * Apply Ultimate Oscillator on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Momentum Indicators.
     *
     */
    ...
    /**
     * Apply Variance on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Statistic Functions.
     *
     */
    ...
    /**
     * Apply Weighted Close Price on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Price Transform.
     *
     */
    ...
    /**
     * Apply Williams' %R on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Momentum Indicators.
     *
     */
    ...
    /**
     * Apply Weighted Moving Average on the provided input and return the most recent output only.
     *
     * This indicator belongs to the group Overlap Studies.
     *
     */
