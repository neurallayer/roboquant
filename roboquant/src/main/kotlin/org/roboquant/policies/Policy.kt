...
/**
 * A policy is responsible for creating [Orders][Instruction], typically based on the [Signals][Signal] generated by a
 * strategy. Besides, turning signals into orders, a policy should also take care of:
 *
...
interface Policy  {
     ...
     */
    fun act(signals: List<Signal>, account: Account, event: Event): List<Instruction>
