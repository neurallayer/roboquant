 ...
 *
 * Please note it is up to the signal2Order to use this additional information and simple implementations might ignore it.
 */
 ...
 *
 * It depends on the signal2Order how these signals are translated into actual orders, but possible scenarios are:
 *
