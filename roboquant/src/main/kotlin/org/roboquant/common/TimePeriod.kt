...
class TimePeriod internal constructor(internal val period: Period, internal val duration: Duration) {
    ...
    companion object {
        ...
        /**
         * Parse the string that is generated by [TimePeriod.toString] back to an instance of TimePeriod.
         */
        fun parse(text: String) : TimePeriod {
            val parts = text.split(' ')
            return TimePeriod(Period.parse(parts[0]), Duration.parse(parts[1]))
        }
