...
class TimePeriod internal constructor(internal val period: Period, internal val duration: Duration) {
    ...
    companion object {
        ...
        /**
         * Parse the string that is generated by [TimePeriod.toString] back to an instance of TimePeriod. This is also
         ...
         * ```
         */
        fun parse(text: String) : TimePeriod {
            val parts = text.split('T')
            return TimePeriod(Period.parse(parts[0]), Duration.parse("PT" + parts[1]))
        }
