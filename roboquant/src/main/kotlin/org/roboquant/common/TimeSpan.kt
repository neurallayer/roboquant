...
class TimeSpan internal constructor(internal val period: Period, internal val duration: Duration) {
    ...
    companion object {
         ...
         *
         * This is also compliant with he ISO 8601 format for durations:
         *
         * ```
    ...
    operator fun plus(other: TimeSpan) =
        TimeSpan(period.plus(other.period), duration.plus(other.duration))

    /**
     * Subtract an [other] trading period
     */
    operator fun minus(other: TimeSpan) =
        TimeSpan(period.minus(other.period), duration.minus(other.duration))
