...
/**
 * A policy is responsible for generating [Orders][Order], typically based on the [Signals][Signal] generated by a
 * strategy. Besides, turning signals into orders, a policy also can take care of:
 *
 ...
 *
 * Please note that the brokers which receives the orders that a Policy generate, might not support all the different
 * order types.
 */
interface Policy : Component {
     ...
     * more orders (for the broker to process).
     */
