...
== Installation
=== Library
Just add `roboquant-core` or any of the other modules as a dependency to your build tool, like Maven or Gradle. See also link:/docs/INSTALL.adoc[installation guide] for more ways to install and use roboquant.
